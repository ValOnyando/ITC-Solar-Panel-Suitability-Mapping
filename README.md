...
│   ├── buildings.geojson       # Fetched from PDOK 3D BAG API (building footprints & heights)
...
- `src/data_acquisition.py` contains all API request logic for fetching building footprints (PDOK BAG) and PVGIS solar data
...
| 🏗️ **[PDOK 3D BAG](https://3dbag.nl/)** | 3D building data with roof footprints and heights | GeoJSON/CityJSON |
